    ...
    <body>
        <nav class="nav-extended light-blue accent-4">
            <div class="container nav-wrapper">
                <a href="#" class="brand-logo">Dona Benta</a>
            ...
            <div class="container nav-content">
                <ul class="tabs tabs-transparent">
                    <li class="tab"><a href="#preco" class="white-text">Preço</a></li>
                    <li class="tab"><a href="#prato" class="white-text">Prato</a></li>
                    <li class="tab"><a href="#cardapio" class="active white-text">Cardapio</a></li>
                    <li class="tab"><a href="#pedido" class="white-text">Pedido</a></li>
                </ul>
            </div>
        </nav>
        <div class="row">
            <div class="col s12">
                <form action="Jantinha.jsp" class="col s12 row" method="post">
                    ...
                    <div id="pedido" class="col s12"></div>
                </form>
            </div>
        </div>
